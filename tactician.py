...
def make_smart_move():
    '''Returns a winning move if available, otherwise random legal move'''
    global fen, moves
    ...
    # Check each move - if opponent has 0 legal moves after, it's checkmate
    for move in legal_moves_list:
        test_moves = moves + [move]
        opponent_legal_moves = sf.legal_moves("xiangqi", fen, test_moves)
